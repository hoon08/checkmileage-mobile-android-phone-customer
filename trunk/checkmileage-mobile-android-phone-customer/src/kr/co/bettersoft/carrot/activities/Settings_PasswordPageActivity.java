 ...
 */
import kr.co.bettersoft.carrot.pref.Password;
...
//				 Toast.makeText(Settings_PasswordPageActivity.this, "잠금 설정 변경", Toast.LENGTH_SHORT).show();
		...
		if(preference.equals(findPreference("preference_lock_password"))){
			...
			Intent passwordIntent = new Intent(Settings_PasswordPageActivity.this, kr.co.bettersoft.carrot.pref.Password.class);
