...
import kr.co.bettersoft.carrot.activities.GCMIntentService;
...
//	    	count = 0;		// 초기화 해준다. 종료하고 다시 실행할 수 있게..
	    	...
	    	if(RunMode.equals("MILEAGE")){			// 마일리지일 경우에는 내 마일리지 목록 재 조회 되도록 변수 값을 설정해준다.	
	    		...
	    		Intent PushListIntent = new Intent(DummyActivity.this, kr.co.bettersoft.carrot.activities.PushList.class);
