...
//		loadingURL = CommonUtils.userAgreeURL;			// URL 정보 *** 기능 뺌
//		mWeb = (WebView)findViewById(R.id.user_agree_web);	//  *** 기능 뺌
...
//		}
//	}
	// 2차 단계(추가 진행 시 호출) - -> 1단계 동의 기능 뺌. 바로 호출
