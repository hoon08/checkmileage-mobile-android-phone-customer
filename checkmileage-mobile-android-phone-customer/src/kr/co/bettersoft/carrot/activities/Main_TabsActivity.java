package kr.co.bettersoft.carrot.activities;
// 메인 메뉴들. 탭1:내QR보기 , 탭2:내마일리지, 탭3:가맹점목록, 탭4:설정
import static kr.co.bettersoft.carrot.activities.CommonUtilities.DISPLAY_MESSAGE_ACTION;
import static kr.co.bettersoft.carrot.activities.CommonUtilities.SENDER_ID;

import java.util.Calendar;
import java.util.List;
import java.util.Locale;

import kr.co.bettersoft.carrot.pref.DummyActivity;
import kr.co.bettersoft.carrot.pref.PrefActivityFromResource;
...
//				.setIndicator("", getResources().getDrawable(R.drawable.bottom_menu4))
				...
				.setContent(new Intent(this, kr.co.bettersoft.carrot.pref.PrefActivityFromResource.class)));  
...
//						tabhost.getTabWidget().getChildAt(0).setBackgroundColor(Color.parseColor("#000000"));
						...
						if(RunMode.length()>0){
							if(RunMode.equals("MILEAGE")){
								...
								Intent PushListIntent = new Intent(Main_TabsActivity.this, kr.co.bettersoft.carrot.activities.PushList.class);
