...
import kr.co.bettersoft.carrot.activities.CommonUtils;
import kr.co.bettersoft.carrot.activities.MainActivity;
import kr.co.bettersoft.carrot.activities.Main_TabsActivity;
import kr.co.bettersoft.carrot.activities.MemberStoreInfoPage;
import kr.co.bettersoft.carrot.activities.MemberStoreListPageActivity;
import kr.co.bettersoft.carrot.activities.MyMileagePageActivity;
import kr.co.bettersoft.carrot.activities.MyQRPageActivity;
import kr.co.bettersoft.carrot.activities.Settings_AboutPageActivity;
import kr.co.bettersoft.carrot.activities.myWebView;
import kr.co.bettersoft.carrot.activities.GCMIntentService.backgroundUpdateMyGCMtoServer;
import kr.co.bettersoft.carrot.domain.CheckMileageMembers;
...
//			AlertShow_Message();				// 준비중입니다.
			...
			Intent PushListIntent = new Intent(PrefActivityFromResource.this, kr.co.bettersoft.carrot.activities.PushList.class);
